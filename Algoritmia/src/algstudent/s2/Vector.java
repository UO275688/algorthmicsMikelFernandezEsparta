...
public abstract class Vector implements ISortingProblem {
	...
	*/
	...
	protected static void interchange(int[] elements, int i, int j) {
		int t;
		t = elements[i];
	...
	protected static int findPosMin(int[] elements, int firstElement) {
	...
	protected static int findPosMax(int[] elements, int firstElement) {
